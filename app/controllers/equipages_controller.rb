class EquipagesController < CrudController
  ...
  def attrs_for_form
[:numero, :type_puissance, :carte_grise, :carte_grise_titulaire, :carte_grise_date_emission, :premiere_mise_en_circ, :immatriculation, :cie_assurance]
  end
...
private
  ...
  def equipage_params
    params.require(:equipage).permit(:numero, :type_puissance, 
      :carte_grise, :carte_grise_titulaire, :carte_grise_date_emission, :premiere_mise_en_circ, :immatriculation, 
      :cie_assurance,
      :user_id)
  end
